...
\section{Stock price prediction trends}
...
Both of these categories can be further divided into fundamental and technical analysis categories depending on what data they use as a source of analysis.
...
Next, we go through some existing pipelines that for which there is some public information available.
...
The strong point of Spark is that same models can be used with Spark Streaming framework, but better latencies can be achieved with Storm making it possibly better choice for companies which have resources \cite{kumar}.
