...
\newcommand{\DATE}{December 18, 2019}
\newcommand{\FDATE}{18. joulukuuta 2019}
...
The goal of this thesis is to provide information and tools that can make this analysis more accessible to novice data analysist.
...
Our study finds that using this method, the resulting pipeline can be build cost-efficiently while keeping the pipeline sustainable and easy to reproduce.
